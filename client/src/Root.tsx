    ...
    <main className={ "bg-base-900 min-h-screen" }>
      ...
      >
        <div className={ "flex flex-col items-end justify-center overflow-hidden md:ml-0 md:mr-0 ml-auto mr-auto" }>
          ...
          {/* Taglines scroller */ }
          <div
            className={ "relative whitespace-nowrap w-full animate__animated animate__slideInRight " +
      ...
      <section
        className={ "text-3xl font-semibold pt-16 grid gap-4 ml-auto mr-auto grid-cols-2 max-w-5xl w-full" }
      >
