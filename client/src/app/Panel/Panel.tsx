  ...
  return (
    <div
      style={{
        ...
        ...(side === "left" && {
          borderRight: "var(--application-panel-border)",
        }),
        ...(side === "right" && {
          borderLeft: "var(--application-panel-border)",
          gridRowEnd: -1,
          gridColumnStart: 2,
        }),
        ...(side === "top" && {
          borderBottom: "var(--application-panel-border)",
        }),
        ...(side === "bottom" && {
          borderTop: "var(--application-panel-border)",
          gridColumnEnd: -1,
          gridRowStart: 2,
        }),
      }}
    ...
    >
      ...
      <PanelInstanceIcon />
      <PanelApplicationLauncher side={side} type={"slideOut"} />
      <IconButton
        onClick={() => {
          setSide("left");
        }}
  ...
  return (
    <section
      className={clsx(
        ...
        visible ? "flex" : "hidden",
        `absolute w-96 bg-[rgb(var(--container-bg))] h-screen`
      )}
      style={{
        ...(side === "left" && {
          borderRight: "var(--application-panel-border)",
  ...
  return (
    <section
      className={clsx(
        ...
        side === "top" &&
          (visible
            ? "animate__backInDown animate__faster"
            : "animate__backOutUp animate__fast"),
        side === "bottom" &&
          (visible
            ? "animate__backInUp animate__faster"
            : "animate__backOutDown animate__fast"),
        side === "left" &&
          (visible
            ? "animate__backInLeft animate__faster"
            : "animate__backOutLeft animate__fast"),
        side === "right" &&
          (visible
            ? "animate__backInRight animate__faster"
            : "animate__backOutRight animate__fast")
      )}
    >
