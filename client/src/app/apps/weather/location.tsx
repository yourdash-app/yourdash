        ...
        >
          ...
          <div className={ "w-56 relative" }>
            <Card
              ...
              className={ clippy( "w-full h-[10.5rem] flex-col transition-[var(--transition)] absolute", selectedDay === 0
                ? "bottom-[3.5rem]"
                : "bottom-0" ) }
            >
            ...
            data.daily.days.slice( 1 ).map( ( day, ind ) => (
              ...
              >
                <Card
                  ...
                  className={ clippy( "w-full h-[10.5rem] flex-col transition-[var(--transition)] absolute", selectedDay === ind + 1
                    ? "bottom-[3.5rem]"
                    : "bottom-0" ) }
                >
                  <section className={ "flex items-center justify-between" }>
