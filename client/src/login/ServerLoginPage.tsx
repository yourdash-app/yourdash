...
const ServerLoginPage: React.FC = () => {
  ...
  return <>
    ...
    <main style={ { backgroundImage: `url('${ serverUrl }/login/background')` } }
      ...
      { selectedUser
        ...
        : <SelectUser setName={ (value) => setName( value ) } serverUrl={ serverUrl }
...
const LoginAsUser: React.FC<{
  ...
  return <>
    <IconButton icon={ "arrow-left-16" } className={ `left-2 top-2 fixed animate__animated animate__fadeInLeft` }
