...
const OnBoarding: React.FC<{
    ...
    pages: {
        ...
        header: string,
        body: string,
        actions: { label: string, icon?: UKIcon, onClick: () => void, changeTo?: "next" | "previous" | "remain" }[],
        allowGoBack?: boolean
    }[]
}> = ({ pages, meta }) => {
    ...
    return <div className={styles.page}>
        {
            page.allowGoBack && <IconButton className={styles.goBackButton} accessibleLabel="Go back to the last page" icon={UKIcon.ChevronLeft} onClick={() => [
