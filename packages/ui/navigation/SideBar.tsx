...
const SideBar: React.FC<ISideBarProps> = ({ items, title, expandedByDefault, headerContent, style }) => {
  const [ expanded, setExpanded ] = useState(expandedByDefault || false)
  return (
    <div className={ styles.component } data-expanded={ expanded } style={ style }>
      <IconButton
