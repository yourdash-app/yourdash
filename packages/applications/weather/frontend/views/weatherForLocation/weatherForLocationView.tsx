...
const WeatherApplicationLocationPage: React.FC<
  IWeatherApplicationLocationPage
> = ({ weatherData }) => {
  ...
  return (
    <div className={"overflow-hidden h-full grid grid-rows-[auto,1fr] bg-bg"}>
      ...
      >
        <div
          className={
            "h-full grid lg:grid-cols-[auto,auto,auto] grid-cols-[1fr] p-4 relative gap-2"
          }
        >
          <section
            className={
              "h-full pr-2 flex flex-col gap-2 w-full max-w-sm flex-wrap"
            }
          >
            {chunk(weatherData.hourly.time, 24)[selectedDay].map(
              (hourDate, ind) => {
                  ...
                  >
                    <img
                      ...
                      src={getWeatherIconFromState(
                        chunk(weatherData.hourly.weatherState, 24)[selectedDay][
                          ind
                        ],
                      )}
                      alt={""}
                    ...
                    <span className={"ml-auto text-xl"}>
                      {
                        chunk(weatherData.hourly.temperature, 24)[selectedDay][
                          ind
                        ]
                      }
          ...
          <section
            className={
              "w-full h-full grid grid-cols-3 gap-2 grid-rows-[auto,1fr]"
            }
          >
            {
