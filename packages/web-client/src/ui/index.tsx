...
export const DateInput = loadable(
  () => import("./components/dateInput/DateInput"),
);
export const Dialog = loadable(() => import("./components/dialog/Dialog"));
export const DropdownButton = loadable(
  () => import("./components/dropdownButton/DropdownButton"),
);
export const DropdownContainer = loadable(
  () => import("./components/dropdownContainer/DropdownContainer"),
);
export const DropdownIconButton = loadable(
  () => import("./components/dropdownIconButton/DropdownIconButton"),
);
export const Heading = loadable(() => import("./components/heading/Heading"));
export const Icon = loadable(() => import("./components/icon/Icon"));
export const IconButton = loadable(
  () => import("./components/iconButton/IconButton"),
);
export const MajorButton = loadable(
  () => import("./components/majorButton/MajorButton"),
);
export const NumberInput = loadable(
  () => import("./components/numberInput/NumberInput"),
);
export const ProgressBar = loadable(
  () => import("./components/progressBar/ProgressBar"),
);
export const ResizeContainer = loadable(
  () => import("./components/resizeContainer/ResizeContainer"),
);
export const RightClickMenu = loadable(
  () => import("./components/rightClickMenu/RightClickMenu"),
);
export const Row = loadable(() => import("./components/row/Row"));
export const SegmentButton = loadable(
  () => import("./components/segmentButton/SegmentButton"),
);
...
export const ToggleSwitch = loadable(
  () => import("./components/toggleSwitch/ToggleSwitch"),
);
export const TabsContainer = loadable(
