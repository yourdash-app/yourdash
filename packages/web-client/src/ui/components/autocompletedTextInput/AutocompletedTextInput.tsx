...
const AutocompletedTextInput: React.FC<IAutocompletedTextInput> = ({
  ...
  return (
    <div className={clippy("relative transition-all border-none", className)}>
      <span
        className={clippy(
          "pl-2 pr-2 bg-base-700 absolute -top-1 left-2.5 text-sm z-10 [line-height:.65rem] select-none text-base-400",
        )}
      >
        {label}
      </span>
