...
const AppLayout: React.FC = () => {
  ...
  if (!loaded)
    return (
      <div
        className={
          "w-full h-full flex items-center justify-center flex-col gap-4"
        }
      >
        {!didTakeTooLong && (
          <>
            ...
            <Card className={"flex items-center justify-center"} showBorder>
              <h1 className={"text-5xl font-bold pl-4 pr-4"}>
                Loading YourDash
              </h1>
            </Card>
          </>
        ...
        >
          <div className={"pl-2 pr-2"}>
            {didTakeTooLong ? (
              <div
                className={
                  "flex gap-2 flex-col -ml-2 -mr-2 items-center justify-center"
                }
              >
                <div className={"flex items-center justify-center"}>
                  <Heading level={3}>
                    Your instance took too long to load
                  </Heading>
                </div>
