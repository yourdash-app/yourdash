    ...
    <>
      ...
      >
        <div className={"flex items-center justify-center h-full w-full"}>
          <img
            ...
            className={
              "ml-auto h-10 pr-1 animate__fadeInDown animate__animated"
            }
            alt={""}
          />
          <h2
            className={
              "font-bold text-3xl animate__fadeInDown animate__animated animate__250ms"
            }
          >
            Your
          </h2>
          <h2
            className={
              "font-bold text-3xl animate__fadeInDown animate__animated animate__500ms"
            }
          >
            Dash
          </h2>
      ...
      >
        ...
        >
          ...
          <Link
            className={
              "text-theme-300 hover:text-theme-400 active:text-theme-200"
            }
