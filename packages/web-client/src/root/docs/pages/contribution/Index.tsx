...
const Index: React.FC = () => {
  ...
  return (
    <main className={ "w-full flex flex-col gap-4 items-center p-4" }>
      <h1 className={ "2xl:text-8xl xl:text-7xl lg:text-6xl md:text-5xl text-4xl font-bold tracking-wide transition-all text-center" }>{ "Contribute to YourDash" }</h1>
      <p className={"animate__animated animate__fadeInDown animate__500ms text-center"}>How to setup YourDash for development or report a problem</p>
