...
const FilesSideBar: React.FC<IFilesSideBar> = () => {
    ...
    if (categories === undefined) return <div className={styles.component} />;
    ...
    return (
                                                                ...
                                                                verifyAndReturnJson(
                                                                    ...
                                                                    () => {
                                                                        return console.error(
                                                                            `unable to delete sidebar category ${ind}`
                                                                        );
                                                                    }
                                                                );
                                                            },
        ...
        */}
                <div className={styles.quota}>
                    <div className={styles.header}>Quota percentage full</div>
