...
import {ChipletRawIconDictionary} from "ui/icon/iconDictionary";
...
const LoginOptions: NextPageWithLayout = () => {
    ...
    useEffect(() => {
        verifyAndReturnJson(
            ...
            json => {
                setCurrentServerBackground(json?.image?.src || ChipletRawIconDictionary["server-error"])
            },
            () => {
                setCurrentServerBackground(ChipletRawIconDictionary["server-error"])
            })
        verifyAndReturnJson(
        ...
        verifyAndReturnJson(
            ...
            json => {
                setCurrentServerLogo(json?.image?.src || ChipletRawIconDictionary["server-error"])
            },
            () => {
                setCurrentServerLogo(ChipletRawIconDictionary["server-error"])
            })
        verifyAndReturnJson(
