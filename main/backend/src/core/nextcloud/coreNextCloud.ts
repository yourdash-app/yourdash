          ...
          data: {
            ...
            capabilities: {
              ...
              theming: {
                ...
                logo: `https://${req.headers.host || "localhost:3563"}/index.php/apps/theming/image/logo?useSvg=1&v=2`,
                background: `https://${req.headers.host || "localhost:3563"}/index.php/apps/theming/image/background?v=2`,
                "background-plain": false,
                "background-default": false,
                logoheader: `https://${req.headers.host || "localhost:3563"}/index.php/apps/theming/image/logo?useSvg=1&v=2`,
                favicon: `https://${req.headers.host || "localhost:3563"}/index.php/apps/theming/image/logo?useSvg=1&v=2`,
              },
            },
          },
        },
