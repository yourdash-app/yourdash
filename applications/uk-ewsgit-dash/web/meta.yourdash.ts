...
} = {"$schema":"../../main/backend/src/core/YourDashApplicationConfigJson.json","id":"uk-ewsgit-dash-frontend","displayName":"Dash","description":"This is the default application description, you can edit this information in this application's 'application.json'","category":"core","license":"MIT","maintainers":[{"name":"Ewsgit","avatarUrl":"https://avatars.githubusercontent.com/u/69800526?v=4","bio":"The creator of YourDash","url":"https://ewsgit.uk"}],"authors":[{"name":"Ewsgit","avatarUrl":"https://avatars.githubusercontent.com/u/69800526?v=4","bio":"The creator of YourDash","url":"https://ewsgit.uk"}],"modules":{"backend":[{"dependencies":[],"description":"The backend for the Dash application","id":"uk-ewsgit-dash-backend","main":"./backend/index.ts"}],"frontend":[],"officialFrontend":[{"id":"uk-ewsgit-dash-frontend","main":"./web/index.tsx","displayName":"Dash","iconPath":"./icon.avif","description":"","dependencies":[{"moduleType":"backend","id":"uk-ewsgit-dash-backend"}]}]},"shouldInstanceRestartOnInstall":true}; export default applicationMeta
