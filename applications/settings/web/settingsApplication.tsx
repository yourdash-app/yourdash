...
const SettingsApplication: React.FC = () => {
  return (
    <BasePageLayout noBack title={"YourDash Settings"}>
      <SettingCategoryComponent href={"/app/a/settings/profile"} description={"Manage your user profile"} title={"Profile"} icon={UKIcon.Person} />
      ...
      />
      <SettingCategoryComponent href={"/app/a/settings/session"} description={"Manage your login sessions"} title={"Login sessions"} icon={UKIcon.Login} />
      <SettingCategoryComponent
      ...
      />
      <SettingCategoryComponent href={"/app/a/settings/admin"} description={"Hiya, Admin 👋"} title={"Admin tools"} icon={UKIcon.Tools} />
      <SettingCategoryComponent
